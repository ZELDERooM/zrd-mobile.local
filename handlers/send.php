...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // 5. Отправляем успешный ответ обратно в JS
        echo "Спасибо, $name! Ваша заявка успешно сохранена. Мы свяжемся с вами по телефону $phone.";

    } catch (\PDOException $e) {
        // Если база данных выдала ошибку
